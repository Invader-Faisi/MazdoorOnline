                    ...
                    <table class="table align-middle mb-0 bg-white">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                $rate = 0;
                                if($employer != null){
                                foreach($employer->GetRating as $rating){
                                if($rating->rating_by == "Labour" && $rating->employer_id == $employer->id){
                                $count++;
                                $rate += $rating->ratings;
                                }
                                }
                    ...
                    <table class="table align-middle mb-0 bg-white">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                $rate = 0;
                                if($labour != null){
                                foreach($labour->GetRating as $rating){
                                if($rating->rating_by == "Employer" && $rating->labour_id == $labour->id){
                                $count++;
                                $rate += $rating->ratings;
                                }
                                }
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span
                                        class="badge badge-success rounded-pill d-inline">{{ $portfolio->status }}</span>
                                    @else
                                    <span
