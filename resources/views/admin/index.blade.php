                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($job->status == 'Approved' || $job->status == 'Assigned')
                                                <span
                                                    class="badge badge-dark rounded-pill d-inline">{{ $job->status }}</span>
                                            @else
                                                <span
                                                    class="badge badge-danger rounded-pill d-inline">{{ $job->status }}</span>
                                            @endif

                                        </td>
                                        <td>
                                            @if ($job->status == 'Approved' || $job->status == 'Assigned')
                                                <a class="btn btn-sm btn-info disabled"><i
                                                        class="fas fa-edit fa-fw"></i></a>
                                            @else
                                                <a class="btn btn-sm btn-success update" data-id="{{ $job->id }}"
                                                    data-action="job"><i class="fas fa-edit fa-fw"></i></a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($portfolio->status == 'Approved')
                                                <span
                                                    class="badge badge-dark rounded-pill d-inline">{{ $portfolio->status }}</span>
                                            @else
                                                <span
                                                    class="badge badge-danger rounded-pill d-inline">{{ $portfolio->status }}</span>
                                            @endif
